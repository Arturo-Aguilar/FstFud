...
namespace CarritoCompras
{
    ...
    {
        public static string ApiFirebase = "https://ventastest1-54c80-default-rtdb.firebaseio.com/";
        private static string KeyAplication = "AIzaSyCIApDaPdsmOe_JzifrNRCfplX_YxxsKBo";
